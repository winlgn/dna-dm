 ...
 * @author lenovo
 */
public class DiscreteBasedOnImportance implements Discretization {
        ...
        while (true) {
            ...
            for (int i = 0; i < instancesBreakPoint.numAttributeBreakPoints; i++) {
                for (int j = 0; j < instancesBreakPoint.attributeBreakPoints[i].numBreakPoints; j++) {
                    ...
                    instancesBreakPoint.attributeBreakPoints[i].breakPoints[j].importance = 0;
                    ...
                    for (pDomain = pDomainStart; pDomain != -1; pDomain = nodes[pDomain].nextDomain) {
                        ...
                        instancesBreakPoint.attributeBreakPoints[i].breakPoints[j].importance += lBreakPoint * rBreakPoint - lrMulProduct;

                    }
                    if (maxImportance < instancesBreakPoint.attributeBreakPoints[i].breakPoints[j].importance) {
                        maxImportance = instancesBreakPoint.attributeBreakPoints[i].breakPoints[j].importance;
                        minPosI = i;
                        minPosJ = j;
                    }
                }
